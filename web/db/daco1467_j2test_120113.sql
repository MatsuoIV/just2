...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-01-2013 a las 19:56:51
...
INSERT INTO `member` (`id`, `state_id`, `country_id`, `firstName`, `lastName`, `street`, `postCode`, `phone`, `mobile`, `dateOfBirth`, `gender`, `user_id`, `height`, `eyeColour`, `hairColour`, `datePreference`, `smoker`, `children`, `relationship`, `profession`, `personality`, `interest_id`) VALUES
(6, 1, 1, '', '', '', '', '', '', '1924-06-15 00:00:00', 'masculinods', NULL, 50, 'asddddddd', 'ffffffffffffff', 'asdasd', 'no', 'tba', 'married', 'tba', 'ffffffffffffffffffffff', ''),
(7, 1, 1, '', '', '', '', '', '', '1927-01-01 00:00:00', 'm', NULL, 70, 'asdsad', 'asd', 'asdasd', 'yes', 'yes', 'single', 'tba', 'asdasd', ''),
...
INSERT INTO `member_interest` (`id`, `interest_id`, `member_id`) VALUES
(3, 4, 6),
(4, 2, 6),
(5, 2, 7),
(6, 3, 7);
